...
import Signup from './pages/RezUI/core/auth/Signup';
import OTPVerify from './pages/RezUI/core/auth/OTPVerify';
import Splash from './pages/RezUI/core/Splash';
import Privacy from './pages/RezUI/core/Privacy';
import Terms from './pages/RezUI/core/Terms';
import Explore from './pages/RezUI/discovery/Explore';
import ExploreNew from './pages/RezUI/discovery/ExploreNew';
import Categories from './pages/RezUI/discovery/Categories';
import Onboarding from './pages/RezUI/core/Onboarding';
import StorePage from './pages/RezUI/shopping/StorePage';
import StoreHub from './pages/RezUI/shopping/StoreHub';
import StoreDetailPage from './pages/RezUI/shopping/StoreDetailPage';
import Wallet from './pages/RezUI/wallet/Wallet';
import Offers from './pages/RezUI/modes/Offers';
import CashStore from './pages/RezUI/modes/CashStore';
import CashStoreTrack from './pages/RezUI/modes/cashstore/CashStoreTrack';
import RezMall from './pages/RezUI/modes/RezMall';
import RezPrive from './pages/RezUI/modes/RezPrive';
import PriveHome from './pages/RezPriveUI/dashboard/PriveHome';
import PrivePrivileges from './pages/RezPriveUI/privileges/PrivePrivileges';
import PriveExplore from './pages/RezPriveUI/explore/PriveExplore';
import PriveInfluence from './pages/RezPriveUI/influence/PriveInfluence';
import PriveTierProgress from './pages/RezPriveUI/tiers/PriveTierProgress';
import PriveOfferDetail from './pages/RezPriveUI/offers/PriveOfferDetail';
import PriveRedeem from './pages/RezPriveUI/redeem/PriveRedeem';
import PriveProfile from './pages/RezPriveUI/profile/PriveProfile';
import PriveStoreDetail from './pages/RezPriveUI/stores/PriveStoreDetail';
import PriveInfluenceHub from './pages/RezPriveUI/influence/PriveInfluenceHub';
import PriveNotifications from './pages/RezPriveUI/notifications/PriveNotifications';
import PriveBrandInvitation from './pages/RezPriveUI/brands/PriveBrandInvitation';
import PriveEarnings from './pages/RezPriveUI/earnings/PriveEarnings';
import PriveActivity from './pages/RezPriveUI/activity/PriveActivity';
import PriveRecognition from './pages/RezPriveUI/recognition/PriveRecognition';
import PriveAuthority from './pages/RezPriveUI/authority/PriveAuthority';
import PriveVisibilityControl from './pages/RezPriveUI/privacy/PriveVisibilityControl';
import PriveActivityStatement from './pages/RezPriveUI/reports/PriveActivityStatement';

// Admin Pages
import AdminDashboard from './pages/HQAdminUI/dashboards/AdminDashboard';
import AdminGlobalDashboard from './pages/HQAdminUI/dashboards/AdminGlobalDashboard';
import AdminMarketingDashboard from './pages/HQAdminUI/dashboards/AdminMarketingDashboard';
import AdminFinanceDashboard from './pages/HQAdminUI/dashboards/AdminFinanceDashboard';
import AdminOperationsDashboard from './pages/HQAdminUI/dashboards/AdminOperationsDashboard';
import AdminRegionalDashboard from './pages/HQAdminUI/dashboards/AdminRegionalDashboard';
import AdminRoleManagement from './pages/HQAdminUI/operations/AdminRoleManagement';
import AdminSupportDashboard from './pages/HQAdminUI/dashboards/AdminSupportDashboard';
import AdminContentDashboard from './pages/HQAdminUI/dashboards/AdminContentDashboard';
import AdminAnalyticsDashboard from './pages/HQAdminUI/dashboards/AdminAnalyticsDashboard';
import AdminModeControl from './pages/HQAdminUI/operations/AdminModeControl';
import AdminCollegeCorporateModule from './pages/HQAdminUI/operations/AdminCollegeCorporateModule';
import AdminCoinIssuanceControl from './pages/HQAdminUI/coins/AdminCoinIssuanceControl';
import AdminCoinRulesEngine from './pages/HQAdminUI/coins/AdminCoinRulesEngine';
import AdminKYCCompliance from './pages/HQAdminUI/operations/AdminKYCCompliance';
import AdminBankReconciliation from './pages/HQAdminUI/finance/AdminBankReconciliation';
import OperationsCityDashboard from './pages/HQAdminUI/dashboards/OperationsCityDashboard';
import AdminUsers from './pages/HQAdminUI/users/AdminUsers';
import AdminMerchants from './pages/HQAdminUI/merchants/AdminMerchants';
import AdminOffers from './pages/HQAdminUI/marketing/AdminOffers';
import AdminAnalytics from './pages/HQAdminUI/analytics/AdminAnalytics';
import AdminCampaigns from './pages/HQAdminUI/marketing/AdminCampaigns';
import AdminCategories from './pages/HQAdminUI/content/AdminCategories';
import AdminContent from './pages/HQAdminUI/content/AdminContent';
import AdminGamification from './pages/HQAdminUI/engagement/AdminGamification';
import AdminReferrals from './pages/HQAdminUI/engagement/AdminReferrals';
import AdminEvents from './pages/HQAdminUI/engagement/AdminEvents';
import AdminSocialImpact from './pages/HQAdminUI/engagement/AdminSocialImpact';
import AdminSettings from './pages/HQAdminUI/settings/AdminSettings';
import AdminSupport from './pages/HQAdminUI/support/AdminSupport';
import AdminTransactions from './pages/HQAdminUI/finance/AdminTransactions';
import AdminCashback from './pages/HQAdminUI/finance/AdminCashback';
import AdminCashbackRates from './pages/HQAdminUI/finance/AdminCashbackRates';
import AdminMerchantPackages from './pages/HQAdminUI/merchants/AdminMerchantPackages';
import AdminPayments from './pages/HQAdminUI/finance/AdminPayments';
import AdminMarketing from './pages/HQAdminUI/marketing/AdminMarketing';
import AdminFraud from './pages/HQAdminUI/operations/AdminFraud';
import AdminSpecialPrograms from './pages/HQAdminUI/engagement/AdminSpecialPrograms';
import AdminIntegrations from './pages/HQAdminUI/operations/AdminIntegrations';
import AdminLogs from './pages/HQAdminUI/operations/AdminLogs';
import AdminUserManagement from './pages/HQAdminUI/users/AdminUserManagement';
import AdminNotifications from './pages/HQAdminUI/support/AdminNotifications';
import AdminWallet from './pages/HQAdminUI/finance/AdminWallet';
import AdminVouchers from './pages/HQAdminUI/marketing/AdminVouchers';
import AdminFlashSales from './pages/HQAdminUI/marketing/AdminFlashSales';
import AdminBankOffers from './pages/HQAdminUI/marketing/AdminBankOffers';
...
import AIRWallet from './pages/air/AIRWallet';
import AIRSaved from './pages/air/AIRSaved';
...
import BuzzLoopExplore from './pages/buzzloop/BuzzLoopExplore';
import BuzzLoopNotifications from './pages/buzzloop/BuzzLoopNotifications';
...
import CoinHuntMyDeals from './pages/coinhunt/CoinHuntMyDeals';
import CoinHuntWallet from './pages/coinhunt/CoinHuntWallet';
...
import MerchantPOS from './pages/BiZoneUI/pos/MerchantPOS';
...
import CreateOffer from './pages/BiZoneUI/offers/CreateOffer';
import MerchantOffers from './pages/BiZoneUI/offers/MerchantOffers';
import MerchantCustomers from './pages/BiZoneUI/customers/MerchantCustomers';
...
import MerchantAnalytics from './pages/BiZoneUI/dashboard/MerchantAnalytics';
import MerchantFinancials from './pages/merchant/MerchantFinancials';
import MerchantMarketing from './pages/BiZoneUI/marketing/MerchantMarketing';
import MerchantSupport from './pages/merchant/MerchantSupport';
import MerchantSettings from './pages/BiZoneUI/advanced/MerchantSettings';
...
import MerchantOrders from './pages/BiZoneUI/orders/MerchantOrders';
import MerchantProducts from './pages/merchant/MerchantProducts';
import MerchantInventory from './pages/BiZoneUI/inventory/MerchantInventory';
...
import MerchantBrandedCoinConfig from './pages/BiZoneUI/advanced/MerchantBrandedCoinConfig';
...
import MerchantSignup from './pages/BiZoneUI/auth/MerchantSignup';
...
import CoinHistory from './pages/RezUI/wallet/coins/CoinHistory';
...
import OrderTracking from './pages/RezUI/shopping/OrderTracking';
import Profile from './pages/RezUI/account/Profile';
...
import DealDetail from './pages/RezUI/deals/DealDetail';
...
import SearchResults from './pages/RezUI/discovery/SearchResults';
import Earn from './pages/Earn';
import OrderHistory from './pages/RezUI/shopping/OrderHistory';
import OrderDetail from './pages/RezUI/shopping/OrderDetail';
import Wishlist from './pages/RezUI/account/Wishlist';
import Notifications from './pages/RezUI/account/Notifications';
import Settings from './pages/RezUI/account/Settings';
import Help from './pages/RezUI/support/Help';
...
import Deals from './pages/RezUI/deals/Deals';
...
// Cart
import Cart from './pages/RezUI/shopping/Cart';
          ...
          <WalletProvider>
            ...
            <Routes>
              ...
              <Route path="/" element={<Layout />}>
                ...
                <Route path="air/wallet" element={<AIRWallet />} />
                <Route path="air/saved" element={<AIRSaved />} />
                ...
                <Route path="buzzloop/explore" element={<BuzzLoopExplore />} />
                <Route path="buzzloop/notifications" element={<BuzzLoopNotifications />} />
                ...
                <Route path="coinhunt/my-deals" element={<CoinHuntMyDeals />} />
                <Route path="coinhunt/wallet" element={<CoinHuntWallet />} />
