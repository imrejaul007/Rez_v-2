    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="text-center">
          <p className="text-xl text-white mb-4">Brand not found</p>
          <button
            onClick={() => navigate(-1)}
  ...
  return (
    <div className="min-h-screen bg-black pb-24">
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="text-sm font-medium text-white">{isFollowing ? 'Following' : 'Follow'}</span>
            </button>
        ...
        <div className="p-6 rounded-3xl bg-gradient-to-br from-emerald-500/20 to-teal-600/10 border border-emerald-500/30">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-white mb-2">{brand.name}</h1>

              <div className="flex items-center gap-2 mb-2">
                <div className="flex items-center gap-1">
                  <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
                  <span className="text-sm font-semibold text-white">{brand.rating}</span>
                  <span className="text-xs text-gray-400">({brand.reviewCount.toLocaleString()})</span>
                </div>
                {brand.verified && (
      ...
      <div className="px-4 mb-6">
        <h2 className="text-xl font-bold text-white mb-4">Your Loyalty with {brand.name}</h2>
        ...
        <div className="p-6 rounded-3xl bg-gradient-to-br from-purple-500/20 to-blue-600/10 border border-purple-500/30">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-white capitalize">{brand.loyaltyLevel} Member</p>
              </div>
            </div>
            <div className="text-right">
              <p className="text-xs text-gray-400">Member since</p>
              <p className="text-sm font-semibold text-white">{brand.memberSince}</p>
            </div>
          </div>
          ...
          <div className="mb-4 p-4 rounded-2xl bg-white/5">
            <div className="flex items-center justify-between mb-2">
              <p className="text-sm font-semibold text-white">This Month's Progress</p>
                ...
                <>
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xl font-bold text-white mb-1">{nextReward.benefit}</p>
                      <p className="text-sm text-gray-300">{nextReward.subtitle}</p>
                    </div>
                  </div>
      ...
      <div className="px-4 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-white">Full Rewards Journey</h3>
          <Badge variant="default" size="sm" className="bg-purple-500/20 text-purple-300 border-purple-500/30">
            ...
            >
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-400 mb-2">{reward.subtitle}</p>
                </div>
              </div>

              <div className="p-3 rounded-xl bg-white/5 mb-3">
                <p className="text-sm font-semibold text-white">{reward.benefit}</p>
              </div>
              ...
              {reward.status === 'current' && reward.progress !== undefined && (
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <p className="text-xs text-gray-400">{reward.progress}/{reward.visits} visits</p>
              ...
              <div className="mt-3 flex items-center justify-between">
                {reward.status === 'claimed' ? (
                  ...
                  <Badge variant="default" size="sm" className="bg-white/10 text-gray-400 border-white/10">
                    🔒 Locked
                  </Badge>
                )}

                {typeof reward.visits === 'number' && (
                  <span className="text-xs text-gray-500">{reward.visits} visits</span>
                )}
              </div>
            </div>
          ))}
      ...
      <div className="px-4 mb-6">
        <div className="p-5 rounded-3xl bg-gradient-to-r from-amber-500/20 to-orange-600/10 border border-amber-500/30">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-white mb-1">{brand.name} Coins</h3>
              <p className="text-sm text-gray-400">Use only at {brand.name} · Never expire</p>
            </div>
            <div className="text-right">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button className="py-3 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold text-sm active:scale-95 transition-transform">
              Redeem Coins
            </button>
            <button className="py-3 rounded-xl bg-white/10 border border-white/20 text-white font-semibold text-sm active:scale-95 transition-transform">
              Earn More
            </button>
          </div>
        </div>
      ...
      <div className="px-4 mb-6">
        <h3 className="text-lg font-bold text-white mb-4">Special Offers Just for You</h3>
          ...
          {activeOffers.map((offer) => (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-bold text-white mb-1">{offer.title}</p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="px-3 py-1.5 rounded-lg bg-emerald-500 text-white text-xs font-semibold active:scale-95 transition-transform">
                      Use Offer
                    </button>
                  </div>
                </div>
      ...
      <div className="px-4 mb-6">
        <div className="p-5 rounded-3xl bg-gradient-to-br from-orange-500/20 to-red-600/10 border border-orange-500/30">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-white mb-1">Your Visit Streak</h3>
              <p className="text-sm text-gray-400">Keep it going to earn bonus rewards</p>
            </div>
            <div className="text-right">
          ...
          <div className="p-4 rounded-2xl bg-white/5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-semibold text-white">Next Reward</p>
            </div>
            <p className="text-sm text-gray-300 mb-3">
      ...
      <div className="px-4 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-white">People Like You Love This Brand</h3>
        ...
        <div className="space-y-3">
          {recentActivity.map((activity) => (
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <p className="text-sm font-semibold text-white">{activity.userName}</p>
                  {activity.verified && (
        ...
        <div className="mt-4 p-4 rounded-2xl bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 text-center">
          <p className="text-sm text-gray-300">
            <span className="font-semibold text-white">3 friends</span> earned rewards here this week
          </p>
        </div>
      </div>
      ...
      <div className="px-4 mb-6">
        <div className="p-5 rounded-3xl bg-gradient-to-br from-pink-500/20 to-purple-600/10 border border-pink-500/30">
          ...
          <div className="space-y-3">
            <button className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between active:scale-98 transition-transform">
              <div className="flex items-center gap-3">
                <Camera className="w-5 h-5 text-blue-400" />
                <div className="text-left">
                  <p className="text-sm font-semibold text-white">Post Photo Review</p>
                  <p className="text-xs text-gray-400">Earn +50 coins</p>
                </div>
              </div>
            ...
            <button className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between active:scale-98 transition-transform">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-400">Earn +30 coins</p>
                </div>
              </div>
              <ChevronRight className="w-5 h-5 text-gray-400" />
            </button>
            ...
            <button className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between active:scale-98 transition-transform">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-400">Faster tier upgrade</p>
                </div>
              </div>
              <ChevronRight className="w-5 h-5 text-gray-400" />
            </button>
      ...
      <div className="px-4 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-white">Your Loyalty History</h3>
          <button
      ...
      <div className="px-4 mb-6">
        <div className="p-5 rounded-2xl bg-gradient-to-r from-blue-500/20 to-purple-600/10 border border-blue-500/30">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-white mb-2">💡 Loyalty Insight</p>
              <p className="text-sm text-gray-300 mb-3">
      ...
      <div className="px-4 mb-6">
        <h3 className="text-sm font-bold text-gray-400 mb-3 uppercase tracking-wide">Coin Types at {brand.name}</h3>

        <div className="space-y-2">
          <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center gap-3">
            <span className="text-2xl">🟢</span>
            <div className="flex-1">
              <p className="text-sm font-semibold text-white">ReZ Coins</p>
              <p className="text-xs text-gray-400">Universal · Use anywhere</p>
            </div>
          ...
          <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-white">{brand.name} Coins</p>
              <p className="text-xs text-gray-400">Store-only · No expiry</p>
            </div>
          ...
          <div className="p-3 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center gap-3">
            <span className="text-2xl">🔥</span>
            <div className="flex-1">
              <p className="text-sm font-semibold text-white">Promo Coins</p>
              <p className="text-xs text-gray-400">Limited-time · Extra boost</p>
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 glass border-t border-white/10 p-4">
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold flex items-center justify-center gap-2 active:scale-95 transition-transform"
          >
          ...
          <button
            ...
            className="flex-1 py-4 rounded-2xl bg-white/10 border border-white/20 text-white font-bold flex items-center justify-center gap-2 active:scale-95 transition-transform"
          >
